...
def meanAnomalyAtFrame(
    ...
    return (
        np.asarray(initialMeanAnomalyRad, dtype=float) - animationSpeed * frame * angularVelocityRad
    )


def planetMeanAnomalyRad(
    planetOrbitalPeriodDays: float, frame: int, animationSpeed: float
) -> float:
