...
class ViewRegistry:
    VIEWS_2D: list[ViewDefinition] = [
        ViewDefinition(
            '0_inner_solar_system', -3.5, 3.5, 80, 'inner_solar_system', 'Inner Solar System'
        ),
        ViewDefinition(
        ...
        ViewDefinition(
            '5_solar_system_with_nearest_stars_10',
            -632410.77088,
            632410.77088,
            80,
            'solar_system_with_nearest_stars_10',
            'Interstellar Neighbors Within 10 Light Years',
        ),
        ViewDefinition(
            '6_solar_system_with_nearest_stars_25',
            -1584189.9811,
            1584189.9811,
            80,
            'solar_system_with_nearest_stars_25',
            'Interstellar Neighbors Within 25 Light Years',
        ),
        ViewDefinition(
            '7_solar_system_with_nearest_stars_30',
            -1897232.3126,
            1897232.3126,
            80,
            'solar_system_with_nearest_stars_30',
            'Interstellar Neighbors Within 30 Light Years',
        ),
    ]
