...
- `tabbys_star_dust_{light,dark}.gif` — real downsampled Kepler light curve (`data/tabbys_star_lightcurve.csv`, BKJD ~1100–1600) with LOS dust sized to the observed dips
