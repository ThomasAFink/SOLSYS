...
_BODY_APPEARANCES: tuple[BodyAppearance, ...] = (
    ...
    _star('kic_7944142', 'KIC 7944142', 'HD 176694'),
    _planet(
        'mercury',
        'Mercury',
        roughness=0.78,
    ...
    # TRAPPIST-1 planets — gallery-grade procedural packs (#69).
    _planet(
        'trappist_1_b',
        'TRAPPIST-1 b',
        roughness=0.70,
